...
const DECK_ID = "jury-presentation";
const OUT_DIR = "C:\\Users\\batyr\\Desktop\\fam1ly\\myownide\\outputs\\jury-presentation";
const REF_DIR = "C:\\Users\\batyr\\Desktop\\fam1ly\\myownide\\tmp\\slides\\jury-presentation\\references";
...
const SOURCES = {
  primary: "Репозиторий проекта, локально запущенный продукт и опубликованный домен sproga.xyz.",
};
...
const SLIDES = [
  {
    ...
    "title": "MyOwnIDE",
    "subtitle": "Браузерная IDE для быстрого запуска кода, анализа асимптотики и стресс-тестов.",
    "expectedVisual": "Титульный слайд проекта с чётким позиционированием.",
    "moment": "Один браузерный инструмент для написания, проверки и валидации решений.",
    "notes": "На первом слайде представьтесь и коротко скажите, что MyOwnIDE — это инструмент, который помогает быстрее проходить цикл решения задачи: написать код, запустить его, оценить сложность и проверить на крайних случаях.",
    "sources": [
      "primary"
    ]
  },
  {
    ...
    "title": "Какую проблему решает проект?",
    "subtitle": "Для олимпиадного программирования и обучения нужен более быстрый и удобный цикл обратной связи, чем у обычного онлайн-компилятора.",
    "expectedVisual": "Слайд с тремя ключевыми проблемами пользователя.",
    "cards": [
      [
        "Разрозненный процесс",
        "Пользователь переключается между компилятором, заметками, сложностью и ручными тестами."
      ],
      [
        "Слабая проверка",
        "Решение может пройти пример, но упасть на пустом массиве, дубликатах или отрицательных числах."
      ],
      [
        "Медленная итерация",
        "При медленной обратной связи время уходит не на алгоритм, а на техническую отладку."
      ]
    ],
    "notes": "Здесь важно подчеркнуть, что задача проекта была не просто сделать ещё один компилятор, а собрать в одном месте полный рабочий цикл решения задач.",
    "sources": [
      "primary"
    ]
  },
  {
    "kicker": "ОСНОВА ПРОДУКТА",
    "title": "Что умеет MyOwnIDE сейчас?",
    "subtitle": "Текущая версия сосредоточена на трёх полезных действиях, которые реально ускоряют решение задач.",
    "expectedVisual": "Слайд с тремя основными функциями продукта.",
    "metrics": [
      [
        "Run",
        "Запуск кода в браузере на нескольких языках",
        "Интеграция с Judge0"
      ],
      [
        "O(...)",
        "Оценка асимптотики через ИИ",
        "Анализ в один клик"
      ],
      [
        "10",
        "Готовые пресеты стресс-тестов для важных крайних случаев",
        "Встроено прямо в интерфейс"
      ]
    ],
    "notes": "На этом слайде логика простая: сначала пользователь запускает код, потом проверяет асимптотику, затем быстро прогоняет решение на типичных крайних случаях.",
    "sources": [
      "primary"
    ]
  },
  {
    ...
    "title": "Как устроен проект внутри?",
    "subtitle": "Система объединяет лёгкий фронтенд, удалённое выполнение кода и AI-сервис для анализа.",
    "expectedVisual": "Архитектурный слайд с тремя техническими блоками.",
    "cards": [
      [
        "Фронтенд",
        "Интерфейс построен на Monaco Editor и собственной оболочке для быстрого цикла ввода и вывода."
      ],
      [
        "Бэкенд",
        "Node.js и Express связывают интерфейс с Judge0 для запуска кода и с ИИ для анализа асимптотики."
      ],
      [
        "Деплой",
        "Проект опубликован на sproga.xyz через Cloudflare Tunnel и может работать даже с домашнего компьютера."
      ]
    ],
    "notes": "Здесь донесите до жюри, что это не просто макет интерфейса, а рабочая система с реальным выполнением кода, ИИ-анализом и опубликованным доступом по домену.",
    "sources": [
      "primary"
    ]
  },
  {
    ...
    "title": "Что показать жюри за 60-90 секунд?",
    "subtitle": "Короткой демонстрации достаточно, чтобы доказать практическую пользу и готовность продукта.",
    "expectedVisual": "Пошаговый сценарий короткой демо-сессии.",
    "cards": [
      [
        "Шаг 1",
        "Открыть sproga.xyz и показать редактор, ввод, вывод, асимптотику и стресс-пресеты."
      ],
      [
        "Шаг 2",
        "Запустить простую задачу на массив и затем нажать Analyze, чтобы показать оценку сложности."
      ],
      [
        "Шаг 3",
        "Сгенерировать крайние случаи: пустой массив, нули, отрицательные числа, рост и спад."
      ]
    ],
    "notes": "Это ваш готовый сценарий живой демонстрации. Делайте быстро и по делу: жюри должно увидеть настоящий пользовательский путь, а не просто красивые слайды.",
    "sources": [
      "primary"
    ]
  },
  {
    "kicker": "ЦЕННОСТЬ И РАЗВИТИЕ",
    "title": "Почему этот проект заслуживает внимания?",
    "subtitle": "Он уже решает реальную пользовательскую задачу и имеет понятный путь дальнейшего роста.",
    "expectedVisual": "Финальный слайд с тремя сильными выводами.",
    "metrics": [
      [
        "1",
        "Один браузерный инструмент для цикла решить-проверить-отладить",
        "Текущая ценность продукта"
      ],
      [
        "2",
        "Две реальные интеграции: запуск кода и ИИ-анализ",
        "Техническая готовность"
      ],
      [
        "Дальше",
        "В будущем: более гибкие стресс-тесты, сохранение сессий и усиление соревновательного сценария",
        "План развития"
      ]
    ],
    "notes": "Финал должен звучать уверенно: MyOwnIDE — это уже рабочий браузерный помощник для решения задач, который можно использовать сейчас и развивать дальше как полноценный продукт.",
    "sources": [
      "primary"
    ]
  }
